...
window.itemsData = {
  ...
  "d001": {
    ...
    group: "Драконы",
    variants: [
      { suffix: "", label: "Базовая", description: "Дракон малый, детализированный.", ozon: "" },
      { suffix: "-m", label: "С магнитом", description: "Дракон с магнитом.", ozon: "" }
    ],
    contacts: { telegram: "@AvenNyan", whatsapp: "+79818522194" },
    colors: [
      { code: "R01", prices: { "": "500 ₽", "-m": "600 ₽" }, ozon: "" },
      { code: "B01", prices: { "": "500 ₽", "-m": "600 ₽" }, ozon: "" },
      { code: "K01", prices: { "": "500 ₽", "-m": "600 ₽" }, ozon: "" }
    ]
  }
};
